...
Effets partiels estimés de GAM 8 : s(toy), s(Temp), te(Temp, Wind)  et non-linéarités capturées par les splines :
Voici les effets partiels estimés pour évaluer les non-linéarités :
